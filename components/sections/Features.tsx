...
const features = [
  {
    title: 'Smart Website Crawler',
    description: 'Crawl your site with depth control, robots.txt respect, and sitemap support.',
    icon: (
  ...
  },
  {
    ...
    description: 'Upload PDF, DOCX, and TXT files with real-time progress tracking.',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: 'Define your agent\'s personality, prompt, and allowed domains.',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: 'Add to any site via script tag or NPM package (@ethora/ai-widget).',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: 'Experience smooth, real-time streaming responses in the chat interface.',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: 'Manage agents, view status, and configure settings from a clean dashboard.',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: 'Toggle light/dark modes and customize colors to match your brand.',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    title: 'Developer API',
    description: 'Full API access for custom integrations and advanced usage.',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
